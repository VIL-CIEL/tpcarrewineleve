========================================================================
    APPLICATION : Vue d'ensemble du projet tpcarrewineleve
========================================================================

AppWizard a créé cette application tpcarrewineleve pour vous.  

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application tpcarrewineleve.

tpcarrewineleve.vcxproj
...
tpcarrewineleve.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé tpcarrewineleve.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
